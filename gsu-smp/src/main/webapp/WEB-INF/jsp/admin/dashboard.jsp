...
************************** this is the Sidebar section ********************************************************************* -->
		...
		<nav class="ts-sidebar">
			<ul class="ts-sidebar-menu">
				<li>
					<input type="text" class="ts-sidebar-search" placeholder="Search clients / prospect...">
				</li>
				<c:forEach var="clientProspect" items="${allClients}">
					<li><a href="/admin/client/${clientProspect.id}/show"> ${clientProspect.companyName} </a></li>					
				</c:forEach>															
										...
										<div class="panel panel-default">
											<div class="panel-body bk-primary text-light">
												<div class="stat-panel text-center">
													<div class="stat-panel-number h1 ">${clients}</div>
									...
									<div class="col-md-3">
										<div class="panel panel-default">
											<div class="panel-body bk-success text-light">
												<div class="stat-panel text-center">
													<div class="stat-panel-number h1 ">${prospect}</div>
													<div class="stat-panel-title text-uppercase">Prospect</div>
												</div>
											</div>
										...
										<div class="panel panel-default">
											<div class="panel-body bk-warning text-light">
												<div class="stat-panel text-center">
													...
													<div class="stat-panel-title text-uppercase">Opportunities</div>
												</div>
											</div>
											<a href="#" class="block-anchor panel-footer text-center">See All &nbsp; <i class="fa fa-arrow-right"></i></a>
										</div>
