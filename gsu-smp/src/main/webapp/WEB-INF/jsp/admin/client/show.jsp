			...
			<div class="tab-content">
				...
				<div class="tab-pane" id="orange">
					<c:forEach var="contact" items="${clientProspect.contacts}"
						...
						<ul class="list-inline" style="border-style: hidden;">
							<li class="list-group-item" style="border-style: hidden;">${contact.firstName},
								${contact.lastName}</li>
							...
							<li style="border-style: hidden;"><button
									style="border-style: hidden;"
									href="#myModal<c:out value="${loop.count}"/>" id="openBtn"
									data-toggle="modal" class="btn btn-default">view
									more...</button></li>
							<li><a style="border-style: hidden;" class="btn btn-info"
								role="button" href="/admin/contact/${contact.id}/update">Update</a></li>
							<li><a style="border-style: hidden;" class="btn btn-danger"
								role="button" href="/admin/contact/${contact.id}/delete">Delete</a></li>
						</ul>
						<hr></hr>
				...
				<div class="tab-pane" id="yellow">
					<c:forEach var="project" items="${clientProspect.projects}"
						...
						<ul class="list-inline" style="border-style: hidden;">
							...
							<li style="border-style: hidden;"><button
									style="border-style: hidden;"
									href="#myproject<c:out value="${loop.count}"/>" id="openBtn"
									data-toggle="modal" class="btn btn-default">view
									more...</button></li>
							<li><a style="border-style: hidden;" class="btn btn-info"
								role="button" href="/admin/project/${project.id}/update">Update</a></li>
						</ul>
						<hr></hr>

						<div class="modal fade"
							id="myproject<c:out value="${loop.count}"/>">
							<div class="modal-dialog">
								<div class="modal-content">
									<div class="modal-header">
										<button type="button" class="close" data-dismiss="modal"
				...
				<div class="tab-pane" id="green">
					<c:forEach var="proposal" items="${clientProspect.proposal}"
						begin="0" end="${clientProspect.proposal.size()}"
						varStatus="loopProposal">
						<ul class="list-inline" style="border-style: hidden;">
							...
							<li style="border-style: hidden;"><button
									style="border-style: hidden;"
									href="#myproposal<c:out value="${loop.count}"/>" id="openBtn"
									data-toggle="modal" class="btn btn-default">view
									more...</button></li>
							<li><a style="border-style: hidden;" class="btn btn-info"
								role="button" href="/admin/proposal/${proposal.id}/update">Update</a></li>
						</ul>
						<hr></hr>

						<div class="modal fade"
							id="myproposal<c:out value="${loop.count}"/>">
							<div class="modal-dialog">
								<div class="modal-content">
									<div class="modal-header">
										<button type="button" class="close" data-dismiss="modal"
				...
				<div class="tab-pane" id="blue">
					<c:forEach var="opportunity" items="${clientProspect.opportunity}"
						begin="0" end="${clientProspect.opportunity.size()}"
						varStatus="loop">
						<ul class="list-inline" style="border-style: hidden;">
							...
							<li style="border-style: hidden;"><button
									style="border-style: hidden;"
									href="#myOpportunity<c:out value="${loop.count}"/>"
									id="openBtn" data-toggle="modal" class="btn btn-default">view
									more...</button></li>
							<li><a style="border-style: hidden;" class="btn btn-info"
								role="button" href="/admin/opportunity/${opportunity.id}/update">Update</a></li>
						</ul>
						<hr></hr>

						<div class="modal fade"
							id="myOpportunity<c:out value="${loop.count}"/>">
							<div class="modal-dialog">
								<div class="modal-content">
									<div class="modal-header">
										<button type="button" class="close" data-dismiss="modal"
